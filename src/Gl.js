...
// Font assets
const fontFile = require("./assets/radikal.fnt");
const fontAtlas = require("./assets/radikal_0.png");
...
export default class {
  ...
  init() {
    ...
    loadFont(fontFile, (err, font) => {
      this.fontGeometry = createGeometry({
        font,
        text: "HUMAN INSIGHTS / Technology",
      });
  ...
  createRenderTarget() {
    ...
    this.rtCamera = new THREE.PerspectiveCamera(45, 2.3, 0.9, 1000);
    ...
    // Adjust dimensions
    this.text.position.set(-2.2, -0.225, 0.1);
    this.text.rotation.set(Math.PI, 0, 0);
    this.text.scale.set(0.011, 0.04, 1);
    // this.text.scale.set(0.009, 0.02, 1);
